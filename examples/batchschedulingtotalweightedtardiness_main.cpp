        ...
        const std::vector<char*> argv)
{
    ...
    desc.add_options()
        ("shift-block-maximum-length,", boost::program_options::value<sequencing::ElementPos>(&parameters.sequencing_parameters.shift_block_maximum_length), "")
        ("swap-block-maximum-length,", boost::program_options::value<sequencing::ElementPos>(&parameters.sequencing_parameters.swap_block_maximum_length), "")
        ("reverse,", boost::program_options::value<bool>(&parameters.sequencing_parameters.reverse), "")
        ("shift-reverse-block-maximum-length,", boost::program_options::value<sequencing::ElementPos>(&(parameters.sequencing_parameters.shift_reverse_block_maximum_length)), "")
        ("double-bridge-number-of-perturbations,", boost::program_options::value<sequencing::ElementPos>(&parameters.sequencing_parameters.double_bridge_number_of_perturbations), "")
        ("ruin-and-recreate-number-of-perturbations,", boost::program_options::value<sequencing::ElementPos>(&parameters.sequencing_parameters.ruin_and_recreate_number_of_perturbations), "")
        ("ruin-and-recreate-number-of-elements-removed,", boost::program_options::value<sequencing::ElementPos>(&parameters.sequencing_parameters.ruin_and_recreate_number_of_elements_removed), "")
...
int main(int argc, char *argv[])
{
    ...
    if (!certificate_path.empty()) {
        ...
        std::vector<std::vector<JobId>> solution;
